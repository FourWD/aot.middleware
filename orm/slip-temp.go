...
type SlipTemp struct {
	...
	PaymentSlip2      string    `json:"payment_slip_2" query:"payment_slip_2" firestore:"payment_slip_2" gorm:"type:varchar(256); column:payment_slip_2;"`
	...
	RefundDate        time.Time `json:"refund_date" query:"refund_date" firestore:"refund_date" gorm:"default:null;"`
	...
	//---FLEET--
	FleetClientID        string `json:"fleet_client_id" query:"fleet_client_id" firestore:"fleet_client_id" gorm:"type:varchar(20); default:null;"`
