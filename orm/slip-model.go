...
type SlipModel struct {
	...
	PaymentAt                 string    `json:"payment_at" query:"payment_at" gorm:"default:null; type:varchar(50); comment:'วันเวลาที่จ่าย' "`
	...
	IsCharge01                bool      `json:"is_charge_01" query:"is_charge_01" gorm:"default:0; type:tinyint(1);"`
	...
	IsCharge02                bool      `json:"is_charge_02" query:"is_charge_02" gorm:"default:0; type:tinyint(1);"`
	...
	IsCharge03                bool      `json:"is_charge_03" query:"is_charge_03" gorm:"default:0; type:tinyint(1);"`
}
