...
type Slip struct {
	...
	SubPassengerName1        string    `json:"sub_passenger_name_1" query:"sub_passenger_name_1" firestore:"sub_passenger_name_1" gorm:"type:varchar(255);column:sub_passenger_name_1;"`
	...
	SubPassengerName2        string    `json:"sub_passenger_name_2" query:"sub_passenger_name_2" firestore:"sub_passenger_name_2" gorm:"type:varchar(255);column:sub_passenger_name_2;"`
	...
	SubPassengerName3        string    `json:"sub_passenger_name_3" query:"sub_passenger_name_3" firestore:"sub_passenger_name_3" gorm:"type:varchar(255);column:sub_passenger_name_3;"`
