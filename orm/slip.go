...
type Slip struct {
	...
	ForceOriginName      string    `json:"force_origin_name" query:"force_origin_name" firestore:"force_origin_name" gorm:"type:text;comment:'กรณีที่ไม่มี POI' "`
	...
	ForceDestinationName string    `json:"force_destination_name" query:"force_destination_name" firestore:"force_destination_name" gorm:"type:text;comment:'กรณีที่ไม่มี POI' "`
	...
	PromotionCode string  `json:"promotion_code" query:"promotion_code" firestore:"promotion_code" gorm:"type:varchar(36);comment:'กรณี duoslip เก็บเลขที่ slip ถ้าkansaiเก็บ เลขของ kansai' "`
